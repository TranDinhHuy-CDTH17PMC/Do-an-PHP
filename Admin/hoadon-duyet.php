...
<body>
	...
	<div class="container">
		...
		<div class="col-sm-10" style="background-color: white;">
			<h1><i class="fa fa-2x fa-bitcoin"  ></i> DUYỆT HÓA ĐƠN</h1>
			<table class="table table-hover table-bordered " style="background-color: white;">
				...
				<tbody>
					...
					<tr class="<?php if($row['trangthai']==1) echo " success "?>">
						...
						<td>
							<button name="xem_cthd" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal<?php echo $row['mahd']?>">Xem chi tiết</button>
							<button name="duyet_hd" type="submit" class="btn btn-success btn-xs">Duyệt</button>
							<!--button name="xoa_hd" type="submit" class="btn btn-danger btn-xs">Xóa</button-->
						</td>
						</form>
						<div class="modal fade" id="myModal<?php echo $row['mahd']?>" role="dialog">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<form action="hoadon-duyet.php" method="post">
									...
									foreach($r as $d){?>
											...
											<div class="form-group">
												...
												<div class="">
													<input type="numberphone" class="form-control" name="sdt" id="sdt" placeholder="0972..." value="<?php echo $d[ 'masp']?>">
												</div>
											</div>
											...
											?>
											<div class="form-group">
												<label class="control-label col-sm-2" for="diachi">Địa chỉ giao hàng</label>
												<div class="">
